...
class CustomActionBarProducts extends StatefulWidget {
  ...
  @override
  State<CustomActionBarProducts> createState() => _CustomActionBarProductsState();
}

class _CustomActionBarProductsState extends State<CustomActionBarProducts> {
...
// 'true','false'  ];
  ...
  // List<String>? selectedEnabledList = [];
  //
        ...
        children: [
          ...
          Container(
            ...
            child: TextField(
              ...
              onChanged: (value) {
                _productsViewModel.find.value = value;
              },
              onTap: () {},
